...
const Skiper41 = () => {
  return (
    <div className="relative flex h-full w-full flex-col items-center justify-center bg-[#fff8d4] text-black/40">
      <ProgressiveBlur position="top" backgroundColor="#fff8d4" height="50%" />
      <ProgressiveBlur position="bottom" backgroundColor="#fff8d4" height="50%" />
